...
There's no need to have output files for R or M input; since the
input files are equivalent, you should get the same output no matter
which input file mode you use.
